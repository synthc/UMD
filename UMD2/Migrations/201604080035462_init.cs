    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.UserMedias", t => t.UserMedia_Id)
                .Index(t => t.Contributor_Id)
                .Index(t => t.Review_Id)
                .Index(t => t.UserMedia_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserMedias", "Review_Id", "dbo.Reviews");
            DropForeignKey("dbo.Comments", "UserMedia_Id", "dbo.UserMedias");
            ...
            DropIndex("dbo.UserMedias", new[] { "Review_Id" });
            ...
            DropIndex("dbo.Comments", new[] { "UserMedia_Id" });
