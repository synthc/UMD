        ...
        protected override void Seed(UMD2.Models.ApplicationDbContext context)
        {
            ...
            Media[] media = new Media[]
            {
                new Movie
                {
                    ...
                    ThumbnailUrl = "http://www.joblo.com/posters/images/full/1995-the-usual-suspects-poster1.jpg",
                ...
                new Movie
                {
                    ...
                    DbDateAdded = DateTime.Now,
                    ThumbnailUrl = "http://movieposters.2038.net/p/Abre-Los-Ojos.jpg",
                ...
                new Movie
                {
                    ...
                    DbDateAdded = DateTime.Now,
                    ThumbnailUrl = "https://www.cinematerial.com/media/posters/md/yk/yk2mbhfz.jpg?v=1456177319",
                ...
                new Movie
                {
                    ...
                    DbDateAdded = DateTime.Now,
                    ThumbnailUrl = "http://ap1.alchetron.com/cdn/Swimming-with-Sharks-images-7564e483-5bc5-4ed3-8742-b8e82e62f0f.jpg?op=OPEN",
                    Genre = "Comedy, Crime",
                    Duration = 93,
                    Type = "movie",
                    IsActive = true,
